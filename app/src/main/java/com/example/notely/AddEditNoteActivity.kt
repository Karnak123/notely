...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.example.notely.EXTRA_ID"
        const val EXTRA_TITLE = "com.example.notely.EXTRA_TITLE"
        const val EXTRA_DESCRIPTION = "com.example.notely.EXTRA_DESCRIPTION"
        const val EXTRA_PRIORITY = "com.example.notely.EXTRA_PRIORITY"
    }
